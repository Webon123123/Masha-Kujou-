...
let tags = {
  ...
  'downloader': '⬇️ D E S C A R G A R ⬇️',
  'tools': '🔧 H E R R A M I E N T A S 🔧',
  'fun': '🎉 D I V E R S I Ó N 🎉',
  'nsfw': '🚫 N S F W 🚫',
  'cmd': '📂 D A T O S 📂',
  'owner': '👑 P R O P I E T A R I O 👑',
  'audio': '🎵 A U D I O S 🎵',
  'advanced': '🛠️ A V A N Z A D O 🛠️',
}

const defaultMenu = {
  before: `
💠━━━━━━━━━━━━━━━━💠
🌟 *Hola %name* 🌟, soy *María Mikhaloivna* 
%greeting 🌞
...
let handler = async (m, { conn, usedPrefix: _p, __dirname }) => {
  try {
    ...
    let pp = 'https://vioo.cc/v/2zU'
    let img = await (await fetch(`https://i.ibb.co/YZYymQr/images-23.jpg`)).buffer()
    await m.react('⭐')
    await conn.sendFile(m.chat, img, 'thumbnail.jpg', text.trim(), m, null, pagina)
  } catch (e) {
    conn.reply(m.chat, 'Ha ocurrido un error con el menú.', m)
    throw e
  }
}
